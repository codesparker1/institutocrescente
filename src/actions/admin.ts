...
/*
 * NÃO acrescentar aqui uma ação que aplique a monografia a todos os cursos de uma vez.
 * Existiu (2026-09-07) e foi removida no mesmo dia: escolhia-se uma disciplina num dropdown e ela
 * ficava marcada como monografia no último ano de TODOS os cursos. Uma escolha distraída
 * transformava uma cadeira normal em monografia em todo o sistema — e a monografia muda o
 * comportamento da avaliação inteira (nota única, sem recurso, fora do fecho de semestre).
 *
 * A monografia entra curso a curso, pelo campo "Tipo" de createCadeiraCurricularAction. É mais
