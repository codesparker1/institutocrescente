...
const RESTRICTED_PREFIXES: { prefix: string; roles: string[] }[] = [
  ...
  // Sala de Comando (§2026-09-11, restringida a 2026-09-13) — instrumentação da simulação, não
  // gestão académica. Só DEV, o mesmo papel do relógio simulado: nem o ADMIN nem o DAAC têm o que
  // fazer aqui, e a lista de corridas expõe ids e percursos de alunos fora do trabalho deles.
  { prefix: "/admin/simulacao", roles: ["DEV"] },
