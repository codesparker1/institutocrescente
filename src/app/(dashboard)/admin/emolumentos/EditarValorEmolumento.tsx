...
import { atualizarValorEmolumentoAction } from "@/actions/admin";

const initialState: { error?: string } = {};

interface EditarValorEmolumentoProps {
  emolumentoId: string;
  valor: number;
}

export function EditarValorEmolumento({ emolumentoId, valor }: EditarValorEmolumentoProps) {
  const [state, formAction, isPending] = useActionState(atualizarValorEmolumentoAction, initialState);
